...
export const baseScheme = z.object({
    ...
    UserNmame: z.string('Indtast venligst dit brugernavn').min(3, "Brugernavn skal være mindst 3 karakterer"),
    age: z.number('Indtast venligst din alder'),
    password: z.string('Indtast venligst dit password').min(6, "Password skal være mindst 6 karakterer"),
