...
export const instructorScheme = z.object({
    ...
    minAge: z.coerce.number({required_error: "Indtast venligst en minimumsalder",invalid_type_error: "Indtast venligst en minimumsalder",})
    .int("Minimumsalder skal være et helt tal")
    .min(1, "Minimumsalder skal være mindst 1"),
    maxAge: z.coerce.number({required_error: "Indtast venligst en maksimumsalder",invalid_type_error: "Indtast venligst en maksimumsalder",})
    .int("Maksimumsalder skal være et helt tal")
    .min(1, "Maksimumsalder skal være mindst 1"),
    maxParticipants: z.coerce.number({required_error: "Indtast venligst et maksimum antal deltagere",invalid_type_error: "Indtast venligst et maksimum antal deltagere",})
